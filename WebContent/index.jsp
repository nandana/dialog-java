...
<body>
	...
	<div class="_demo--container">
		...
		<div class="banner--service-info">
			...
			<div class="banner--service-description">The Dialog service uses a rules-based system to enable efficient and useful interactions between virtual agents and users.</div>
			...
			<div class="banner--service-links">
				<li class="base--li banner--service-link-item">
					<a href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/apis/#!/dialog" class="base--a">API Overview</a>
				</li>
				<li class="base--li banner--service-link-item">
					...
					<div class="chat-box--pane">
							...
							<div class="chat-box--container">
								...
								<div class="chat-box--message">
									<div class="chat-box--message-vertical">
										<p class="chat-box--message-text base--p">Welcome to X-Phone Orders Direct. What can I do for you?</p>
									</div>
								</div>
							</div>
						</div>
						<div class="chat-box--item_YOU chat-box--item chat-box--item_HIDDEN">
							<div class="chat-box--container">
								<div class="chat-box--message">
									<div class="chat-box--message-vertical">
										<p class="chat-box--message-text base--p">hello</p>
									</div>
								</div>
